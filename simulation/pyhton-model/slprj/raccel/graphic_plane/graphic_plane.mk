...
MODEL                   = graphic_plane
MODULES                 = rt_logging_simtarget.c graphic_plane.c graphic_plane_capi.c graphic_plane_data.c graphic_plane_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = graphic_plane.exe
MAKEFILE                = graphic_plane.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2022a
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2022a
START_DIR               = C:\Users\sevak\PycharmProjects\MPK\simulation\pyhton-model
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = graphic_plane_ref.rsp
COMPILER_COMMAND_FILE     = graphic_plane_comp.rsp
